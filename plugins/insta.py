...
async def link_handler(Mbot, message):
    ...
    try:
        ...
        if url.endswith("="):
           dump_file=await message.reply_video(url[:-1],caption="ᴘᴏᴡᴇʀᴇᴅ ʙʏ - <a href='https://t.me/MoviesHubFree4You'>ᴍᴏᴠɪᴇsʜᴜʙғʀᴇᴇ𝟺ʏᴏᴜ</a>")
        else:
            dump_file=await message.reply_video(url,caption="ᴘᴏᴡᴇʀᴇᴅ ʙʏ - <a href='https://t.me/MoviesHubFree4You'>ᴍᴏᴠɪᴇsʜᴜʙғʀᴇᴇ𝟺ʏᴏᴜ</a>")
        ...
        try:
            if "/reel/" in url:
               ...
               try:
                   if ddinsta:
                      dump_file=await message.reply_video(content_value,caption="ᴘᴏᴡᴇʀᴇᴅ ʙʏ - <a href='https://t.me/MoviesHubFree4You'>ᴍᴏᴠɪᴇsʜᴜʙғʀᴇᴇ𝟺ʏᴏᴜ</a>")
                   else:
                       dump_file=await message.reply_video(content_value, caption="ᴘᴏᴡᴇʀᴇᴅ ʙʏ - <a href='https://t.me/MoviesHubFree4You'>ᴍᴏᴠɪᴇsʜᴜʙғʀᴇᴇ𝟺ʏᴏᴜ</a>")
               except:
              ...
              #    await message.reply(meta)
                  for i in range(len(meta) - 1):
                     ...
                     await asyncio.sleep(1)
                     try:
                        dump_file=await message.reply_video(com.text,caption="ᴘᴏᴡᴇʀᴇᴅ ʙʏ - <a href='https://t.me/MoviesHubFree4You'>ᴍᴏᴠɪᴇsʜᴜʙғʀᴇᴇ𝟺ʏᴏᴜ</a>")
                        await com.delete()
                     except:
                         pass 
            elif "stories" in url:
                  ...
                  if meta_tag.ok:
                     ...
                     meta=re.findall(r'href="(https?://[^"]+)"', res['data']) 
                      ...
                      return await message.reply("Oops something went wrong")
                  try:
                     dump_file=await message.reply_video(meta[0], caption="ᴘᴏᴡᴇʀᴇᴅ ʙʏ - <a href='https://t.me/MoviesHubFree4You'>ᴍᴏᴠɪᴇsʜᴜʙғʀᴇᴇ𝟺ʏᴏᴜ</a>")
                  except:
